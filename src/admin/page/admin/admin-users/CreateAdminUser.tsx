...
import { addAdminUser } from 'admin/api/admin-users'
...
export default function CreateAdminUser() {
    ...
    const [userPrivilege, setUserPrivilege] = useState<'admin' | 'super_admin'>('super_admin')
    ...
    const onCreateUser = useCallback(
        async (moveToUsersPage: boolean) => {
            ...
            try {
                ...
                if (moveToUsersPage) {
                    history.push(`/admin/admin_users/${result.id}`)
                }
            } catch {
    ...
    return (
        <PageWrapper>
            <Heading mb={4}>管理者ユーザ新規作成</Heading>
